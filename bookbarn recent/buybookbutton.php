    ...
    <div id="sellPopup">
        <div id="sellPopupContainer" style="height:670px">
            <div class="closeSellPopupDiv">
                <a href="sell.html?email=<?php echo $email ?>">
            ...
            <div class="headingDiv">
                <span class="heading">Post Your Books</span>
            </div>
...
$query = "INSERT Into customerdetails values('','$name' , '$addressline1' , '$addressline2', '$landmark', '$district', '$pincode', '$phonenumber' )";
